...
class Business(models.Model):
    ...
    region = fields.CharField(null=False, default="Unspecified", max_length=100)
...
class Product(models.Model):
    ...
    image = fields.CharField(null=False, default="defaultproduct.jpg", max_length=200)
    business = fields.ForeignKeyField("models.Business", related_name="products")


User_Pydantic = pydantic_model_creator(User, name="User", exclude=("is_verified",))
UserIn_Pydantic = pydantic_model_creator(User, name="UserIn", exclude_readonly=True, exclude=("is_verified", "date_joined"))
